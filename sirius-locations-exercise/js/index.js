...
for(const currentCountry of locationList) {
    let insertFlag = $("<img>");
    if(currentCountry.country == "United States") {
        insertFlag.attr("src", "/sirius-locations-exercise/images/flags/united-states.png");
    } else if(currentCountry.country == "India") {
        insertFlag.attr("src", "/sirius-locations-exercise/images/flags/India.png");
    } else if(currentCountry.country == "Canada") {
        insertFlag.attr("src", "/sirius-locations-exercise/images/flags/canada.png");
    }
    let tableRow = $("<tr>");
    let tableCell1 = $("<td>");
    let tableCell2 = $("<td>");
    let tableCell3 = $("<td>");
    let tableCell4 = $("<td>");
    $(".insertLocations").append(tableRow);
    tableRow.append(tableCell1);
    tableRow.append(tableCell2);
    tableRow.append(tableCell3);
    tableRow.append(tableCell4);
    tableCell1.append(insertFlag);
    tableCell2.append(currentCountry.state);
    tableCell3.append(currentCountry.city);
    tableCell4.append(currentCountry.contact);
}